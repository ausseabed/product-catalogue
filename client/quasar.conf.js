  ...
  return {
    ...
    framework: {
      ...
      components: [
        ...
        'QTd', 'QMarkupTable', 'QCircularProgress', 'QLinearProgress'
      ],
    ...
    pwa: {
      ...
      manifest: {
        ...
        description: 'A simple application for specifying properties of bathymetry products',
        display: 'standalone',
