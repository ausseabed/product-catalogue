...
export class CompilationsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async compilationsControllerCreate(compilationDto: CompilationDto, options?: Configuration): Promise<RequestContext> {
     ...
     */
    public async compilationsControllerFindAll(snapshotDateTime?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
     ...
     * @param compilationId 
     */
    public async compilationsControllerFindOne(compilationId: number, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
     ...
     * @param compilationId 
     */
    public async compilationsControllerRemove(compilationId: number, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
     ...
     * @param compilationDto 
     */
    public async compilationsControllerUpdate(compilationId: number, compilationDto: CompilationDto, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
