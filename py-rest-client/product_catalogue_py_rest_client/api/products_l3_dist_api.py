...
class ProductsL3DistApi(object):
    ...
    def products_l3_dist_controller_create(self, product_l3_src_id, product_l3_dist_dto, **kwargs):  # noqa: E501
        ...
        :param product_l3_src_id: (required)
        :type product_l3_src_id: float
        :param product_l3_dist_dto: (required)
        :type product_l3_dist_dto: ProductL3DistDto
    ...
    def products_l3_dist_controller_create_with_http_info(self, product_l3_src_id, product_l3_dist_dto, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ProductL3Dist, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        query_params = []
        if 'product_l3_src_id' in local_var_params and local_var_params['product_l3_src_id'] is not None:  # noqa: E501
            query_params.append(('productL3SrcId', local_var_params['product_l3_src_id']))  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='ProductL3Dist',  # noqa: E501
    ...
    def products_l3_dist_controller_find_all_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(list[ProductL3Dist], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[ProductL3Dist]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
