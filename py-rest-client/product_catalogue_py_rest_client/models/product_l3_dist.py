...
class ProductL3Dist(object):
    ...
    def __init__(self, id=None, source_product=None, l3_coverage_location=None, bathymetry_location=None, bathymetry_bag_location=None, hillshade_location=None, local_vars_configuration=None):  # noqa: E501
