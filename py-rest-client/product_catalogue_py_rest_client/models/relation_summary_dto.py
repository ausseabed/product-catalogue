...
class RelationSummaryDto(object):
    ...
    def __init__(self, relation_id=None, survey_id=None, product_id=None, product_name=None, local_vars_configuration=None):  # noqa: E501
