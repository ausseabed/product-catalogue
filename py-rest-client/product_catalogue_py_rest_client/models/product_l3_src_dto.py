...
class ProductL3SrcDto(object):
    ...
    def __init__(self, metadata_persistent_id=None, name=None, product_tif_location=None, resolution=None, srs=None, uuid=None, vertical_datum=None, local_vars_configuration=None):  # noqa: E501
    ...
    def vertical_datum(self):
        """Gets the vertical_datum of this ProductL3SrcDto.  # noqa: E501
        ...
        :return: The vertical_datum of this ProductL3SrcDto.  # noqa: E501
        :rtype: str
        """
    ...
    def vertical_datum(self, vertical_datum):
        """Sets the vertical_datum of this ProductL3SrcDto.

        Vertical datum of bathymetry * `Lat` - Lowest Astronomical Tide * `AHD` - Australian Height Datum * `LMSL` - LMSL - Local Mean Sea Level (or just Mean Sea Level) * `WGS84` - WGS84 'Ellipsoid'  # noqa: E501

        :param vertical_datum: The vertical_datum of this ProductL3SrcDto.  # noqa: E501
        :type: str
        """
